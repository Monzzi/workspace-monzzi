...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage("Registro exitoso. Redirigiendo a la lista de usuarios...");
    ...
    const createTeacher = async (userId) => {
        const newTeacher = { dni, name, last_name: lastName, date_of_birth: dateOfBirth, user_id: userId };
        ...
        try {
            ...
            setError("El usuario se creó, pero hubo un problema al crear el profesor.");
        }
    };
